...
export type HeyQueryVariables = Exact<{ [key: string]: never; }>;


export type HeyQuery = { __typename?: 'Query', hey: string };
 ...
 * });
 */
export function useHeyQuery(baseOptions?: Apollo.QueryHookOptions<HeyQuery, HeyQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<HeyQuery, HeyQueryVariables>(HeyDocument, options);
      }
export function useHeyLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<HeyQuery, HeyQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<HeyQuery, HeyQueryVariables>(HeyDocument, options);
        }
...
export type HeyQueryResult = Apollo.QueryResult<HeyQuery, HeyQueryVariables>;
